...
#+end_src
*** COMMENT or use awap grids and csiro access
*** awap
#+name:or use awap grids and csiro access
#+begin_src R :session *R* :tangle code/awap_grids_on_nswsd.R :exports none :eval no
  #### name:or use awap grids and csiro access ####
  ...
  png("figures_and_tables/qc_sdmap.png")
  plot(shp)
  dev.off()
  shp@data
