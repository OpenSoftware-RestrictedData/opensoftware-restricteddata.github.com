...
researcher Dr Stephen Begg, dissatisfied with the time it was taking
the data custodians to provide data, had hacked into information about
...
The Reproducibility Crisis `r citep(bib[["Peng2011"]])` has emerged,
...
to avoid the problems a lack of confidence in scientific publications
would entail. Appropriate access to data and analytic software
...
## Motivating case study: Climate and suicide
